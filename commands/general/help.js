            ...
            pages: [
                ...
                new Discord.MessageEmbed()
                    ...
                    .addFields(
                        ...
                        { name: '⚔️ `socials`', value: 'All of Potato Social Medias' },
                        { name: '⚔️ `invite`', value: 'The invite to the Potato Bot Discord Server' }
                    )
                    .setColor('#8098EA')
                ...
                new Discord.MessageEmbed()
                    .setTitle('Potato Bot Random Chat Events')
                    .setAuthor('#PotatoBot', logo)
