...
module.exports = {
    ...
    async execute(bot, message, args) {
        ...
        let yes = [
            `You and your beloved team won the World Championship in Volleyball. As a reward you get a part of the prize. You are now ${amount} ${emoji} richer! Congrats!`,
            `You were elected the best Basketball player this year and won ${amount} ${emoji}.`,
            `Your team did very well in the Hockey Championship and got 3rd place. You still won ${amount} ${emoji}!`,
            `Your Soccer team won the Champions League and you got ${amount} ${emoji}!`,
            `You defeated the best Table-Tennis player in the world and your fans donated you ${amount} ${emoji}!`,
            `You got the chance to compete in the Surf Pro League and you performed very well getting you ${amount} ${emoji}.`,
            `You got a contract to play in a team that is a League above you and you got ${amount} ${emoji} as a bonus!`,
            `Your team won the NFL and you got ${amount} ${emoji} for it`
        ]
        let no = [
        ...
        if (sports !== null && timeout - (Date.now() - sports) > 0) {
            ...
            message.reply(`You've already played with your team recently. You are tired and need to wait \`${time.minutes}m ${time.seconds}s\``)
        } else {
