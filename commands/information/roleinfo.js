...
module.exports = {
    ...
    try {
        const roleName = message.guild.roles.cache.find(r => r.name.toLowerCase() === args.join(' ').toLowerCase() || r.id === args.join(' ').toString()) || message.mentions.roles.first()
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: perms.join(', ').replace(/_/g, " ").toLowerCase() || "None"
                }
            )
        ...
        return message.reply("Role Doesn't Exist").then(() => console.log(e))
    }
    }
}
